...
const initGame = () => {
    ...
    for (let i = wordArray.length - 1; i > 0; i--){
        ...
        // shuffling ans swiping wordArray letters randomly
        [wordArray[i], wordArray[j]] = [wordArray[j], wordArray[i]];
    }
    wordText.innerText = wordArray.join(""); //passing shuffled word text
...
const checkWord = () => {
   ...
   if(userWord !== correctWord) return alert(`Oops! ${userWord.toUpperCase()} is not a correct word`);
